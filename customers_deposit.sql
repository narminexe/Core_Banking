...
create or replace procedure cb_custdep_insert (
p_customer_id number, p_deposit_product_id number, p_contract_no varchar2, p_deposit_amount varchar2, p_profit_amount varchar2, p_start_date date) is
 begin
...
create or replace procedure cb_custdep_update (
p_id number, p_customer_id number default null, 
p_deposit_product_id number default null, 
p_contract_no varchar2 default null, p_deposit_amount varchar2 default null, p_profit_amount varchar2 default null,
p_start_date date default null) is
begin
update cb_customer_deposits set customer_id=nvl(p_customer_id,p_customer_id),   
    ...
    begin
     cb_custdep_insert(1,1,'0001',100,0,sysdate);
     end;
     
     begin
      cb_custdep_update(1,p_start_date=>sysdate-1);
      end;
